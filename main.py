...
def recommended_movies():
    ...
    for likes in liked_movies:
        output = get_recommendations(likes["original_title"])
        all_recommended = all_recommended.append(output)

    all_recommended.drop_duplicates(subset = ['original_tilte'],inplace = True)
    ...
    for index,row in all_recommended.iterrows():
        ...
        recommended_movies_data.append(rn)
    return jsonify({
